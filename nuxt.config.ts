export default defineNuxtConfig({
  ...
  app: {
    head: {
      title: 'Зарабатывайте больше Gold Apple',
      titleTemplate: '%s',
      meta: [
        {
          name: 'viewport',
      ...
      link: [
        ...
        { rel: 'stylesheet', href: 'https://fonts.googleapis.com/css2?family=Inter:wght@400;500&family=Noto+Sans+Linear+B&display=swap' }
      ],
    },
  },
